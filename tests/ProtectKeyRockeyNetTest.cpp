...
const protect_key_t ProtectKeyRockeyNetTest::create_rockey_net_key(const feature_t feature, const size_t licenses_amount) {
	...
	return create_rockey_net_key(feature, licenses_amount, check_methods_memory);
}
