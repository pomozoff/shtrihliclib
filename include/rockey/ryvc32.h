...
#define  ERR_NO_DRIVER			2		// No install drivers
...
#define  ERR_PRNPORT_BUSY		0x101		// Parallel busy
...
uint16_t Rockey(uint16_t function, uint16_t* handle, uint32_t* lp1,  uint32_t* lp2, uint16_t* p1, uint16_t* p2, uint16_t* p3, uint16_t* p4, uint8_t* buffer);
